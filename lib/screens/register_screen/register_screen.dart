                  ...
                  children: [
                    const SizedBox(height: 50,),
                     ...
                     Text(
                      "Hey Newbie!",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: Colors.black.withOpacity(0.7)),
                    ),
                     Text(
                      "Yor are welcome \n       to join us",
                      style:
                          TextStyle(fontSize: 14, fontWeight: FontWeight.bold,color: Colors.black.withOpacity(0.7)),
                    ),
                    const SizedBox(height: 20,),
                    CustomTextField(onSubmit: (e) {},
                    ...
                    CustomButton(onTap: (){}, btnTxt: "Sign Up", backgroundColor: MyTheme.accent_color),
